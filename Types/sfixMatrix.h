...
inline sfixMatrix operator*(const sfixMatrix &a, const sfixMatrix &b)
{
    ...
    MultVerifier::push_matrix_triple(a.share(), b.share(), res.checked());
    return res;
}
...
inline sfixMatrix mult_cwise(const sfixMatrix &a, const sfixMatrix &b)
{
    ...
    res.sharings.reduce_truncate();
    MultVerifier::push_triples(a.share(), b.share(), res.checked());
    return res;
}
...
inline void sfixMatrix::distribute_shares()
{
    ...
    sharings.input_blocks_dispersed_PRG(true);
}
...
{
    return cfixMatrix(sharings.reveal(true));
}
...
inline sfixMatrix& sfixMatrix::mult_cwise(const sfixMatrix&other)
{
    ...
    MultVerifier::push_triples(tmp, other.share(), checked());
    return *this;
}
