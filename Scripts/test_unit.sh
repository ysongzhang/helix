...
./test_units.x 2 $which_test $BENCH_NUM $TRUE_OFFLINE >> /dev/null &
./test_units.x 1 $which_test $BENCH_NUM $TRUE_OFFLINE >> /dev/null &
./test_units.x 0 $which_test $BENCH_NUM $TRUE_OFFLINE
