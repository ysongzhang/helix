...
root = "/home/helix/Inference/MiniONN/"
path = root + "preload/"
np.savetxt(fname=path+"weight1", delimiter=" ", X=params[0][1].reshape(5*5*1, 16).tolist())
np.savetxt(fname=path+"bias1", delimiter=" ", X=params[1][1].tolist())
np.savetxt(fname=path+"weight2", delimiter=" ", X=params[2][1].reshape(5*5*16, 16).tolist())
