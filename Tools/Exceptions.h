...
class Verify_Protocol_Error: public runtime_error
    {
      public:
      Verify_Protocol_Error(string m) :
          runtime_error("Verify-Protocol-Error : " + m) {}
    };
...
class mult_verify_fail:  public bad_value
    {
      public:
      mult_verify_fail(string msg = "Multiply Verification Failure") : bad_value(msg) {}
    };
class reveal_verify_fail:  public bad_value
    {
      public:
      reveal_verify_fail(string msg = "Reveal Verification Failure") : bad_value(msg) {}
    };
class share_verify_fail:  public bad_value
    {
      public:
      share_verify_fail(string msg = "Share Verification Failure") : bad_value(msg) {}
    };
class reveal_error:  public bad_value
    {
      public:
      reveal_error(string msg = "Incorrect Reveal") : bad_value(msg) {}
    };
...
class abort_error: public runtime_error
{
public:
    abort_error(string msg): 
        runtime_error("Abort in "+msg){}
};
